...
if(isset($_SESSION['username']))
{
	...
	if(isset($_POST['ans']))
	{
		...
		if($ans == '2d00f6a428909f241ea48b073cb31d88')
		{
			...
			if($lvl == 2)
			{
			$lvlupdate = mysql_query("UPDATE use_reco SET lvl=3, lvl2='$clear', lastclear='$clear' WHERE uid='$_COOKIE[user]'");
...
<div id="quesbox">
<div id="ques">
<img src="near/1.jpg" width="120" height="104" /><img src="near/doors.jpg" width="104" height="104" />
</div>
<div id="answ">
