...
if(isset($_SESSION['username']))
{
	...
	if(isset($_POST['ans']))
	{
		...
		if($ans == '20b572643c3007e2739703cb82130a8c')
		{
			...
			if($lvl == 10)
			{
			$lvlupdate = mysql_query("UPDATE use_reco SET lvl=11, lvl10='$clear', lastclear='$clear' WHERE uid='$_COOKIE[user]'");
...
<div id="quesbox">
<div id="ques">
<img src="near/10.jpg" height="350" width="450" />
</div>
<div id="answ">
