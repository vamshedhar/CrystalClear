...
if(isset($_SESSION['username']))
{
	...
	if(isset($_POST['ans']))
	{
		...
		if($ans == 'cf80b423f26c461507118798388d5e5a')
		{
			...
			if($lvl == 8)
			{
			$lvlupdate = mysql_query("UPDATE use_reco SET lvl=9, lvl8='$clear', lastclear='$clear' WHERE uid='$_COOKIE[user]'");
...
<div id="quesbox">
<div id="ques">
While making a shield with a hammer,<br />
Blacksmith lost his eye..:-( 
</div>
<div id="answ">
