...
if(isset($_SESSION['username']))
{
	...
	if(isset($_POST['ans']))
	{
		...
		if($ans == '0aeb1e9d1c86884b30231bb66027df8d')
		{
			...
			if($lvl == 1)
			{
			$lvlupdate = mysql_query("UPDATE use_reco SET lvl=2, lvl1='$clear', lastclear='$clear' WHERE uid='$_COOKIE[user]'");
...
<div id="quesbox">
<div id="ques">
<img src="near/2.jpg"/><img src="near/c1.jpg" />
</div>
<div id="answ">
