...
if(isset($_SESSION['username']))
{
	...
	if(isset($_POST['ans']))
	{
		...
		if($ans == '8bdfa6e61534411803b548dcedbf4f64')
		{
			...
			if($lvl == 7)
			{
			$lvlupdate = mysql_query("UPDATE use_reco SET lvl=8, lvl7='$clear', lastclear='$clear' WHERE uid='$_COOKIE[user]'");
...
<div id="quesbox">
<div id="ques">
<img src="near/shifu.jpg" width="550" height="400" />
</div>
<div id="answ">
