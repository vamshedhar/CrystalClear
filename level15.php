...
if(isset($_SESSION['username']))
{
	...
	if(isset($_POST['ans']))
	{
		...
		if($ans == 'd0ce84972fa442d106874c3cf7ad152f')
		{
			...
			if($lvl == 15)
			{
			$lvlupdate = mysql_query("UPDATE use_reco SET lvl=16, lvl15='$clear', lastclear='$clear' WHERE uid='$_COOKIE[user]'");
...
<div id="quesbox">
<div id="ques">
<img src="near/whereami.jpg" height="350" width="430" />
</div>
<div id="answ">
